...
parser.add_argument(
    "-data_root", type=str, default="/mnt/sda3/yigedabuliu/lkq/data/Task01_BrainTumour/npy",
    help="Path to the npy data root."
)
parser.add_argument(
    "-pretrained_checkpoint", type=str, default="/mnt/sda3/yigedabuliu/lkq/LiteMedSAM/work_dir/LiteMedSAM/lite_medsam.pth",
